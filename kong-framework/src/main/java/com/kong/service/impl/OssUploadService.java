...
import com.kong.utils.PathUtils;
...
public class OssUploadService implements UploadService {
    ...
    private String accessKey = "dzT1G5p7HPoP60PCf7OnvcJPNrL-ltcg7n4noYuW";
    private String secretKey = "2pV0nFQSdSkbxBdi6MI5KRA-Lz-g0ifr3K4JpznV";
    private String bucket = "kong-blog";
    ...
    private String uploadOss(MultipartFile imgFile, String filePath){
        ...
        try {
            ...
            try {
                ...
                return "http://rjqg570yk.hn-bkt.clouddn.com/"+key;
