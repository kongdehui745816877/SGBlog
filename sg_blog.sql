...
CREATE TABLE `sg_article`  (
  ...
  `thumbnail` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '缩略图',
  `is_top` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT '0' COMMENT '是否置顶（0否，1是）',
  `status` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT '1' COMMENT '状态（0已发布，1草稿）',
  `view_count` bigint(200) DEFAULT 0 COMMENT '访问量',
  `is_comment` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT '1' COMMENT '是否允许评论 1是，0否',
...
) ENGINE = InnoDB AUTO_INCREMENT = 10 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '文章表' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of sg_article
-- ----------------------------
INSERT INTO `sg_article` VALUES (1, 'SpringSecurity从入门到精通', '## 课程介绍\n![image20211219121555979.png](https://sg-blog-oss.oss-cn-beijing.aliyuncs.com/2022/01/31/e7131718e9e64faeaf3fe16404186eb4.png)\n\n## 0. 简介1\n\n​	**Spring Security** 是 Spring 家族中的一个安全管理框架。相比与另外一个安全框架**Shiro**，它提供了更丰富的功能，社区资源也比Shiro丰富。\n\n​	一般来说中大型的项目都是使用**SpringSecurity** 来做安全框架。小项目有Shiro的比较多，因为相比与SpringSecurity，Shiro的上手更加的简单。\n\n​	 一般Web应用的需要进行**认证**和**授权**。\n\n​		**认证：验证当前访问系统的是不是本系统的用户，并且要确认具体是哪个用户**\n\n​		**授权：经过认证后判断当前用户是否有权限进行某个操作**\n\n​	而认证和授权也是SpringSecurity作为安全框架的核心功能。\n\n\n\n## 1. 快速入门\n\n### 1.1 准备工作\n\n​	我们先要搭建一个简单的SpringBoot工程\n\n① 设置父工程 添加依赖\n\n~~~~\n    <parent>\n        <groupId>org.springframework.boot</groupId>\n        <artifactId>spring-boot-starter-parent</artifactId>\n        <version>2.5.0</version>\n    </parent>\n    <dependencies>\n        <dependency>\n            <groupId>org.springframework.boot</groupId>\n            <artifactId>spring-boot-starter-web</artifactId>\n        </dependency>\n        <dependency>\n            <groupId>org.projectlombok</groupId>\n            <artifactId>lombok</artifactId>\n            <optional>true</optional>\n        </dependency>\n    </dependencies>\n~~~~\n\n② 创建启动类\n\n~~~~\n@SpringBootApplication\npublic class SecurityApplication {\n\n    public static void main(String[] args) {\n        SpringApplication.run(SecurityApplication.class,args);\n    }\n}\n\n~~~~\n\n③ 创建Controller\n\n~~~~java\n\nimport org.springframework.web.bind.annotation.RequestMapping;\nimport org.springframework.web.bind.annotation.RestController;\n\n@RestController\npublic class HelloController {\n\n    @RequestMapping(\"/hello\")\n    public String hello(){\n        return \"hello\";\n    }\n}\n\n~~~~\n\n\n\n### 1.2 引入SpringSecurity\n\n​	在SpringBoot项目中使用SpringSecurity我们只需要引入依赖即可实现入门案例。\n\n~~~~xml\n        <dependency>\n            <groupId>org.springframework.boot</groupId>\n            <artifactId>spring-boot-starter-security</artifactId>\n        </dependency>\n~~~~\n\n​	引入依赖后我们在尝试去访问之前的接口就会自动跳转到一个SpringSecurity的默认登陆页面，默认用户名是user,密码会输出在控制台。\n\n​	必须登陆之后才能对接口进行访问。\n\n\n\n## 2. 认证\n\n### 2.1 登陆校验流程\n![image20211215094003288.png](https://sg-blog-oss.oss-cn-beijing.aliyuncs.com/2022/01/31/414a87eeed344828b5b00ffa80178958.png)', 'SpringSecurity框架教程-Spring Security+JWT实现项目级前端分离认证授权', 1, 'https://sg-blog-oss.oss-cn-beijing.aliyuncs.com/2022/01/31/948597e164614902ab1662ba8452e106.png', '1', '0', 126, '0', NULL, '2022-01-23 23:20:11', NULL, '2022-10-22 07:09:31', 0);
...
INSERT INTO `sg_article` VALUES (5, 'springboot', '![Snipaste_20220115_165812.png](https://sg-blog-oss.oss-cn-beijing.aliyuncs.com/2022/01/15/1d9d283f5d874b468078b183e4b98b71.png)\r\n\r\n## sda \r\n\r\n222\r\n### sdasd newnewnew', 'springboot入门', 2, 'https://sg-blog-oss.oss-cn-beijing.aliyuncs.com/2022/01/15/fd2e9460c58a4af3bbeae5d9ed581688.png', '1', '0', 48, '0', NULL, '2022-01-17 14:58:37', NULL, NULL, 0);
INSERT INTO `sg_article` VALUES (6, '项目部署3333', '#部署java项目\n##准备工作\nLinux Java打包的Jar文件', '部署前后端分离的Java项目', 1, 'http://rjqg570yk.hn-bkt.clouddn.com/2022/10/19/c057d3f690cf4a3b9f853e6008db3e17.png', '0', '0', 0, '0', 1, '2022-10-19 07:26:05', NULL, '2022-10-22 07:09:39', 0);
INSERT INTO `sg_article` VALUES (7, '测试', 'test', 'test', 1, 'http://rjqg570yk.hn-bkt.clouddn.com/2022/10/22/d7a169aa67864e8da7a153365af4d32a.png', '1', '0', 0, '0', 1, '2022-10-22 07:10:17', 1, '2022-10-22 07:10:17', 1);
INSERT INTO `sg_article` VALUES (8, '测试', '', '测试', 1, '', '1', '0', 0, '0', 1, '2022-10-22 07:20:17', 1, '2022-10-22 07:20:17', 1);
INSERT INTO `sg_article` VALUES (9, '测试2 ', '', '测试2', 1, '', '1', '0', 0, '0', 1, '2022-10-22 07:20:27', 1, '2022-10-22 07:20:27', 1);
...
) ENGINE = InnoDB AUTO_INCREMENT = 10 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '文章标签关联表' ROW_FORMAT = Compact;
...
INSERT INTO `sg_article_tag` VALUES (7, 1);
INSERT INTO `sg_article_tag` VALUES (7, 8);
...
INSERT INTO `sg_article_tag` VALUES (9, 8);
...
CREATE TABLE `sg_category`  (
  ...
  `status` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT '0' COMMENT '状态0:正常,1禁用',
...
INSERT INTO `sg_category` VALUES (3, 'PHP', -1, 'PH', '0', NULL, NULL, NULL, NULL, 1);
INSERT INTO `sg_category` VALUES (4, 'PYthon', -1, '22', '0', NULL, NULL, NULL, NULL, 1);
INSERT INTO `sg_category` VALUES (5, 'C++ccc', -1, 'cCCC', '0', NULL, NULL, NULL, NULL, 1);
...
CREATE TABLE `sg_comment`  (
  ...
  `type` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT '0' COMMENT '评论类型（0代表文章评论，1代表友链评论）',
...
INSERT INTO `sg_comment` VALUES (31, '0', 1, -1, '新评论测试', -1, -1, 1, '2022-10-13 23:12:54', 1, '2022-10-13 23:12:54', 0);
INSERT INTO `sg_comment` VALUES (32, '0', 1, 3, '谁才是大多数[偷笑]', 1, 3, 1, '2022-10-13 23:25:39', 1, '2022-10-13 23:25:39', 0);
INSERT INTO `sg_comment` VALUES (33, '1', 1, -1, '友链测试', -1, -1, 1, '2022-10-14 15:11:57', 1, '2022-10-14 15:11:57', 0);
INSERT INTO `sg_comment` VALUES (34, '1', 1, 33, '测试子评论', 1, 33, 1, '2022-10-14 15:12:10', 1, '2022-10-14 15:12:10', 0);
INSERT INTO `sg_comment` VALUES (35, '0', 1, -1, '新头像', -1, -1, 1, '2022-10-14 15:40:51', 1, '2022-10-14 15:40:51', 0);
INSERT INTO `sg_comment` VALUES (36, '0', 1, -1, '评论测试2', -1, -1, 1, '2022-10-16 15:52:39', 1, '2022-10-16 15:52:39', 0);
INSERT INTO `sg_comment` VALUES (37, '0', 1, -1, 'ni xin', -1, -1, 1, '2022-10-19 09:47:10', 1, '2022-10-19 09:47:10', 0);
...
CREATE TABLE `sg_link`  (
  ...
  `address` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '网站地址',
  `status` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT '2' COMMENT '审核状态 (0代表审核通过，1代表审核未通过，2代表未审核)',
  `create_by` bigint(20) DEFAULT NULL,
  `create_time` datetime DEFAULT NULL,
  `update_by` bigint(20) DEFAULT NULL,
  `update_time` datetime DEFAULT NULL,
  `del_flag` int(1) DEFAULT 0 COMMENT '删除标志（0代表未删除，1代表已删除）',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '友链' ROW_FORMAT = Compact;
...
INSERT INTO `sg_link` VALUES (4, 'OSS新增', 'bkt.clouddn.com/2022/10/18/0c2d808c41d240cbade69d558d90c8ea.png', 'oss', 'www.githubs.cn', '2', NULL, NULL, NULL, NULL, 1);
...
CREATE TABLE `sg_tag`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `name` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '标签名',
  `create_by` bigint(20) DEFAULT NULL,
  `create_time` datetime DEFAULT NULL,
  `update_by` bigint(20) DEFAULT NULL,
  `update_time` datetime DEFAULT NULL,
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 11 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '标签' ROW_FORMAT = Compact;
...
INSERT INTO `sg_tag` VALUES (4, 'Java', NULL, '2022-01-13 15:22:43', NULL, '2022-10-19 01:11:16', 0, 'sdadssss');
INSERT INTO `sg_tag` VALUES (5, 'WAD', NULL, '2022-01-13 15:22:47', NULL, '2022-01-13 15:22:47', 1, 'ASDAD');
INSERT INTO `sg_tag` VALUES (7, 'C++', 1, '2022-10-19 01:00:12', 1, '2022-10-19 01:00:12', 1, 'c');
INSERT INTO `sg_tag` VALUES (8, 'PHP', 1, '2022-10-19 01:20:26', 1, '2022-10-19 01:20:26', 0, 'p');
INSERT INTO `sg_tag` VALUES (9, 'C++', 1, '2022-10-19 01:20:31', 1, '2022-10-19 01:20:31', 1, 'c');
INSERT INTO `sg_tag` VALUES (10, 'Python', 1, '2022-10-19 01:20:46', 1, '2022-10-19 01:20:46', 1, 's');
...
CREATE TABLE `sys_menu`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2030 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '菜单权限表' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of sys_menu
-- ----------------------------
INSERT INTO `sys_menu` VALUES (1, '系统管理', 0, 1, 'system', NULL, 1, 'M', '0', '0', '', 'system', 0, '2021-11-12 10:46:19', 0, NULL, '系统管理目录', '0');
INSERT INTO `sys_menu` VALUES (100, '用户管理', 1, 2, 'user', 'system/user/index', 1, 'C', '0', '0', 'system:user:list', 'user', 0, '2021-11-12 10:46:19', 1, '2022-07-31 15:47:58', '用户管理菜单', '0');
INSERT INTO `sys_menu` VALUES (101, '角色管理', 1, 1, 'role', 'system/role/index', 1, 'C', '0', '0', 'system:role:list', 'peoples', 0, '2021-11-12 10:46:19', 0, NULL, '角色管理菜单', '0');
...
INSERT INTO `sys_menu` VALUES (2029, 'sssssss', 2023, 0, '', NULL, 1, 'F', '0', '0', 'sss', '#', NULL, NULL, NULL, NULL, '', '1');
...
CREATE TABLE `sys_role`  (
  ...
  `del_flag` char(1) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT '0' COMMENT '删除标志（0代表存在 1代表删除）',
  `create_by` bigint(20) DEFAULT NULL COMMENT '创建者',
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  `update_by` bigint(20) DEFAULT NULL COMMENT '更新者',
  `update_time` datetime DEFAULT NULL COMMENT '更新时间',
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 46 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '角色信息表' ROW_FORMAT = Compact;
...
INSERT INTO `sys_role` VALUES (11, '嘎嘎嘎1111', 'aggag', 5, '0', '0', NULL, '2022-01-06 14:07:40', NULL, '2022-01-07 03:48:48', '嘎嘎嘎');
INSERT INTO `sys_role` VALUES (12, '友链审核员2', 'link', 1, '0', '0', NULL, '2022-01-16 06:49:30', NULL, '2022-01-16 08:05:09', NULL);
INSERT INTO `sys_role` VALUES (14, 'we', 'we', 0, '0', '1', NULL, NULL, NULL, NULL, NULL);
INSERT INTO `sys_role` VALUES (15, 'we', 'we', 0, '0', '1', 1, '2022-10-24 07:13:56', 1, '2022-10-24 07:13:56', NULL);
INSERT INTO `sys_role` VALUES (17, 'we', 'we', 0, '0', '1', 1, '2022-10-24 07:17:44', 1, '2022-10-24 07:17:44', NULL);
INSERT INTO `sys_role` VALUES (18, 'we', 'we', 0, '0', '1', 1, '2022-10-24 07:18:46', 1, '2022-10-24 07:18:46', NULL);
INSERT INTO `sys_role` VALUES (19, 'we', 'we', 0, '0', '1', 1, '2022-10-24 07:19:34', 1, '2022-10-24 07:19:34', NULL);
INSERT INTO `sys_role` VALUES (22, 'we', 'we', 1, '0', '1', 1, '2022-10-24 07:46:10', 1, '2022-10-24 07:46:10', NULL);
INSERT INTO `sys_role` VALUES (27, 'we', 'we', 1, '0', '1', 1, '2022-10-24 08:04:14', 1, '2022-10-24 08:04:14', NULL);
INSERT INTO `sys_role` VALUES (36, 'we', 'we', 1, '0', '1', 1, '2022-10-24 08:42:31', 1, '2022-10-24 08:42:31', NULL);
INSERT INTO `sys_role` VALUES (40, 'wewww', 'we', 5, '0', '1', 1, '2022-10-24 08:44:38', 1, '2022-10-24 08:44:38', NULL);
INSERT INTO `sys_role` VALUES (43, 'we', 'we', 1, '0', '0', 1, '2022-10-24 08:47:41', 1, '2022-10-24 09:00:05', NULL);
INSERT INTO `sys_role` VALUES (44, 'we2', 'we2', 0, '0', '0', 1, '2022-10-24 08:47:51', 1, '2022-10-24 08:47:51', NULL);
INSERT INTO `sys_role` VALUES (45, 'kong', 'admin', 1, '0', '0', 1, '2022-10-24 09:00:27', 1, '2022-10-24 09:00:27', NULL);
...
INSERT INTO `sys_role_menu` VALUES (36, 2023);
INSERT INTO `sys_role_menu` VALUES (40, 2023);
INSERT INTO `sys_role_menu` VALUES (43, 2017);
INSERT INTO `sys_role_menu` VALUES (43, 2018);
INSERT INTO `sys_role_menu` VALUES (43, 2019);
INSERT INTO `sys_role_menu` VALUES (43, 2021);
INSERT INTO `sys_role_menu` VALUES (43, 2022);
INSERT INTO `sys_role_menu` VALUES (43, 2024);
INSERT INTO `sys_role_menu` VALUES (43, 2025);
INSERT INTO `sys_role_menu` VALUES (43, 2026);
INSERT INTO `sys_role_menu` VALUES (43, 2027);
INSERT INTO `sys_role_menu` VALUES (43, 2028);
INSERT INTO `sys_role_menu` VALUES (44, 1);
INSERT INTO `sys_role_menu` VALUES (44, 100);
INSERT INTO `sys_role_menu` VALUES (44, 101);
INSERT INTO `sys_role_menu` VALUES (44, 102);
INSERT INTO `sys_role_menu` VALUES (44, 1001);
INSERT INTO `sys_role_menu` VALUES (44, 1002);
INSERT INTO `sys_role_menu` VALUES (44, 1003);
INSERT INTO `sys_role_menu` VALUES (44, 1004);
INSERT INTO `sys_role_menu` VALUES (44, 1005);
INSERT INTO `sys_role_menu` VALUES (44, 1006);
INSERT INTO `sys_role_menu` VALUES (44, 1007);
INSERT INTO `sys_role_menu` VALUES (44, 1008);
INSERT INTO `sys_role_menu` VALUES (44, 1009);
INSERT INTO `sys_role_menu` VALUES (44, 1010);
INSERT INTO `sys_role_menu` VALUES (44, 1011);
INSERT INTO `sys_role_menu` VALUES (44, 1012);
INSERT INTO `sys_role_menu` VALUES (44, 1013);
INSERT INTO `sys_role_menu` VALUES (44, 1014);
INSERT INTO `sys_role_menu` VALUES (44, 1015);
INSERT INTO `sys_role_menu` VALUES (44, 1016);
INSERT INTO `sys_role_menu` VALUES (45, 1);
INSERT INTO `sys_role_menu` VALUES (45, 100);
INSERT INTO `sys_role_menu` VALUES (45, 101);
INSERT INTO `sys_role_menu` VALUES (45, 102);
INSERT INTO `sys_role_menu` VALUES (45, 1001);
INSERT INTO `sys_role_menu` VALUES (45, 1002);
INSERT INTO `sys_role_menu` VALUES (45, 1003);
INSERT INTO `sys_role_menu` VALUES (45, 1004);
INSERT INTO `sys_role_menu` VALUES (45, 1005);
INSERT INTO `sys_role_menu` VALUES (45, 1006);
INSERT INTO `sys_role_menu` VALUES (45, 1007);
INSERT INTO `sys_role_menu` VALUES (45, 1008);
INSERT INTO `sys_role_menu` VALUES (45, 1009);
INSERT INTO `sys_role_menu` VALUES (45, 1010);
INSERT INTO `sys_role_menu` VALUES (45, 1011);
INSERT INTO `sys_role_menu` VALUES (45, 1012);
INSERT INTO `sys_role_menu` VALUES (45, 1013);
INSERT INTO `sys_role_menu` VALUES (45, 1014);
INSERT INTO `sys_role_menu` VALUES (45, 1015);
INSERT INTO `sys_role_menu` VALUES (45, 1016);
INSERT INTO `sys_role_menu` VALUES (45, 2017);
INSERT INTO `sys_role_menu` VALUES (45, 2018);
INSERT INTO `sys_role_menu` VALUES (45, 2019);
INSERT INTO `sys_role_menu` VALUES (45, 2021);
INSERT INTO `sys_role_menu` VALUES (45, 2022);
INSERT INTO `sys_role_menu` VALUES (45, 2023);
INSERT INTO `sys_role_menu` VALUES (45, 2024);
INSERT INTO `sys_role_menu` VALUES (45, 2025);
INSERT INTO `sys_role_menu` VALUES (45, 2026);
INSERT INTO `sys_role_menu` VALUES (45, 2027);
INSERT INTO `sys_role_menu` VALUES (45, 2028);
...
CREATE TABLE `sys_user`  (
  ...
  `type` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT '0' COMMENT '用户类型：0代表普通用户，1代表管理员',
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 'sg', 'kong', '$2a$10$Jnq31rRkNV3RNzXe0REsEOSKaYK8UgVZZqlNlNXqn.JeVcj2NdeZy', '1', '0', '23412332@qq.com', '18888888888', '0', 'http://rjqg570yk.hn-bkt.clouddn.com/2022/10/18/0c2d808c41d240cbade69d558d90c8ea.png', NULL, '2022-01-05 09:01:56', 1, '2022-01-30 15:37:03', 0);
INSERT INTO `sys_user` VALUES (3, 'sg3', 'weqe', '$2a$10$Jnq31rRkNV3RNzXe0REsEOSKaYK8UgVZZqlNlNXqn.JeVcj2NdeZy', '1', '0', NULL, NULL, '1', 'http://rjqg570yk.hn-bkt.clouddn.com/2022/10/15/9c4e605a41c74372af579d1dacd4622f.png', NULL, '2022-01-05 13:28:43', NULL, '2022-01-05 13:28:43', 0);
...
INSERT INTO `sys_user` VALUES (14787164048663, 'kong', '辉哥222', '$2a$10$Ur2oWXBZvINA4RW/PT1rAOdwVt.H81Zldrqlz8Rx9g2kTBCWpObiy', '0', '0', '745816877@qq.com', NULL, NULL, NULL, NULL, NULL, NULL, '2022-10-23 15:08:59', 0);
INSERT INTO `sys_user` VALUES (14787164048664, 'kong2', 'hui22', '$2a$10$3z0RlAfuATExE2gVujFGNe2N00mB9Dtpi/CLUTu0fF2MpCeU.uiT6', '0', '0', '7458167@qq.com', '15220309771', '0', NULL, NULL, NULL, NULL, '2022-10-23 15:09:20', 1);
...
INSERT INTO `sys_user_role` VALUES (14787164048664, 11);
